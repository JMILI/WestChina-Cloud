package com.westChina.common.core.constant;
...
public class TenantConstants {
    ...
    /** 子库必须数据表（系统 11 + CT 4 + 素材 2） */
    public static final String[] SLAVE_TABLE = {
            "sys_dept", "sys_logininfor", "sys_notice", "sys_notice_log", "sys_oper_log", "sys_organize_role",
            "sys_post", "sys_role", "sys_role_dept_post", "sys_role_system_menu", "sys_user",
