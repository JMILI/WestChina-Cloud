<div align="center"><h3 align="center">WestChina-Cloud 多租户Saas快速开发平台</h3></div>
<p align="center">     
    <p align="center">
        <a>
            <img src="https://img.shields.io/badge/WestChina%20Cloud-v4.2.4-brightgreen" alt="westChina-cloud">
        </a>
        <a>
...
**[WestChina-MultiSaas](https://gitee.com/westChinatiantang/WestChina-MultiSaas)**
...
- **演示**
    >https://demo.westChinatt.cn         
- **文档**
    >https://doc.westChinatt.cn     
- **视频**
...
├── westChina-gateway         // 网关模块 [8080]
├── westChina-auth            // 认证中心 [9200]
├── westChina-api             // 接口模块
│       └── westChina-api-system                          // 系统接口
├── westChina-common          // 通用模块
│       ├── westChina-common-core                         // 核心模块
│       ├── westChina-common-datascope                    // 权限范围
│       ├── westChina-common-datasource                   // 多数据源
│       ├── westChina-common-message                      // 消息队列
│       ├── westChina-common-socket                       // 消息推送
│       ├── westChina-common-log                          // 日志记录
│       ├── westChina-common-redis                        // 缓存服务
│       ├── westChina-common-security                     // 安全模块
│       └── westChina-common-swagger                      // 系统接口
├── westChina-modules         // 业务模块
│       ├── westChina-file                                // 文件服务 [9300]
│       ├── westChina-gen                                 // 代码生成 [9400]
│       ├── westChina-job                                 // 定时任务 [9500]
│       ├── westChina-tenant                              // 租管模块 [9700]
│       └── westChina-system                              // 系统模块 [9600]
│               ├── authority                         // 权限模块
│               ├── cache                             // 缓存加载
│               ├── dict                              // 参数字典
│               ├── material                          // 素材模块
...
│               ├── organize                          // 组织模块
│               └── role                              // 权限关系
├── westChina-visual          // 图形化管理模块
│       └── westChina-visual-monitor                      // 监控中心 [9100]
└── pom.xml                // 公共依赖
~~~
