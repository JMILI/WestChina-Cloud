  ...
  configureWebpack: {
    ...
    resolve: {
      alias: {
        ...
        'cornerstoneWADOImageLoaderCodecs': resolve('static/cornerstoneWADOImageLoaderCodecs.js'),
        'cornerstoneWADOImageLoaderWebWorker': resolve('static/cornerstoneWADOImageLoaderWebWorker.js'),
        'cornerstoneWADOImageLoader': resolve('static/cornerstoneWADOImageLoader.js'),
      }
    },
    devtool: 'source-map',
    plugins: [
