...
const hideToolCursor = cornerstoneTools.import('hideToolCursor')
const setToolCursor = cornerstoneTools.import('setToolCursor')
const freehandUtils = cornerstoneTools.import('util/freehandUtils')
const moveHandleNearImagePoint = cornerstoneTools.import('manipulators/moveHandleNearImagePoint')
const freehandRoiCursor = cornerstoneTools.import('tools/cursors')
 ...
 */
export default class FreehandRoiToolOfMe extends BaseAnnotationTool {
  constructor(props = {}) {
    const defaultProps = {
      name: 'FreehandRoiOfMe',
  ...
  renderToolData(evt) {
    ...
    function textBoxText(data) {
      ...
      if (area) {
        ...
        const areaText = `Area: ${numbersWithCommas(temp.toFixed(2))}${suffix}`;
