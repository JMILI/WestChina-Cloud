...
(
    pat_id bigint not null comment '唯一id，标识病人'
        primary key,
    pat_card_id varchar (20) not null comment '身份证号',
    pat_name varchar (30) null comment '病人姓名',
    pat_phone varchar (11) null comment '病人手机号码',
...
(
    dicom_id            bigint             not null comment 'id'
        primary key,
    pat_card_id         varchar(20)        not null comment '身份证号',
    dicom_ct_time       varchar(30) null comment 'ct拍摄时间',
    dicom_ct_study_uid  varchar(500) null comment '研究UId',
    dicom_ct_series_uid varchar(500) null comment '序列UId',
...
INSERT INTO `sys_config`
VALUES (4, '账号自助-是否开启租户注册功能', 'sys.account.registerTenant', 'false', 'Y', NULL, '2022-03-06 21:36:40', NULL, NULL,
        '是否开启注册租户功能（true开启，false关闭）', 0, -1);
...
VALUES (-4, 0, '-4', '华西运维', '0', '', '', '', 0, '0', 'N', NULL, '2022-03-06 16:24:06', -2, '2022-03-06 20:48:35', NULL,
        0, -1);
...
INSERT INTO `sys_dict_data`
VALUES (6, 1, '正常', '0', 'sys_normal_disable', '', 'primary', 'Y', '0', 0, '2022-03-06 21:36:39', NULL, NULL, '正常状态');
INSERT INTO `sys_dict_data`
VALUES (7, 2, '停用', '1', 'sys_normal_disable', '', 'danger', 'N', '0', 0, '2022-03-06 21:36:39', NULL, NULL, '停用状态');
INSERT INTO `sys_dict_data`
...
INSERT INTO `sys_dict_data`
VALUES (16, 1, '正常', '0', 'sys_notice_status', '', 'primary', 'Y', '0', 0, '2022-03-06 21:36:39', NULL, NULL, '正常状态');
INSERT INTO `sys_dict_data`
VALUES (17, 2, '关闭', '1', 'sys_notice_status', '', 'danger', 'N', '0', 0, '2022-03-06 21:36:39', NULL, NULL, '关闭状态');
INSERT INTO `sys_dict_data`
...
INSERT INTO `sys_dict_data`
VALUES (25, 8, '生成代码', '8', 'sys_oper_type', '', 'warning', 'N', '0', 0, '2022-03-06 21:36:39', NULL, NULL, '生成操作');
INSERT INTO `sys_dict_data`
VALUES (26, 9, '清空数据', '9', 'sys_oper_type', '', 'danger', 'N', '0', 0, '2022-03-06 21:36:39', NULL, NULL, '清空操作');
INSERT INTO `sys_dict_data`
VALUES (27, 1, '成功', '0', 'sys_common_status', '', 'primary', 'N', '0', 0, '2022-03-06 21:36:39', NULL, NULL, '正常状态');
INSERT INTO `sys_dict_data`
VALUES (28, 2, '失败', '1', 'sys_common_status', '', 'danger', 'N', '0', 0, '2022-03-06 21:36:39', NULL, NULL, '停用状态');
INSERT INTO `sys_dict_data`
VALUES (29, 1, '授权码模式', 'authorization_code', 'sys_grant_type', '', '', 'N', '0', 0, '2022-03-06 21:36:39', NULL, NULL,
        '授权码模式');
INSERT INTO `sys_dict_data`
VALUES (30, 2, '密码模式', 'password', 'sys_grant_type', '', '', 'N', '0', 0, '2022-03-06 21:36:39', NULL, NULL, '密码模式');
INSERT INTO `sys_dict_data`
VALUES (31, 3, '客户端模式', 'client_credentials', 'sys_grant_type', '', '', 'N', '0', 0, '2022-03-06 21:36:39', NULL, NULL,
        '客户端模式');
INSERT INTO `sys_dict_data`
VALUES (32, 4, '简化模式', 'implicit', 'sys_grant_type', '', '', 'N', '0', 0, '2022-03-06 21:36:39', NULL, NULL, '简化模式');
INSERT INTO `sys_dict_data`
VALUES (33, 5, '刷新模式', 'refresh_token', 'sys_grant_type', '', '', 'N', '0', 0, '2022-03-06 21:36:39', NULL, NULL,
        '刷新模式');
INSERT INTO `sys_dict_data`
VALUES (34, 1, '内部跳转', '0', 'sys_jump_type', '', '', 'N', '0', 0, '2022-03-06 21:36:39', NULL, NULL, '路由内部跳转');
INSERT INTO `sys_dict_data`
VALUES (35, 2, '外部跳转', '1', 'sys_jump_type', '', '', 'N', '0', 0, '2022-03-06 21:36:39', NULL, NULL, '路由外部跳转');
INSERT INTO `sys_dict_data`
...
INSERT INTO `sys_dict_data`
VALUES (39, 1, '子数据源', '0', 'sys_database_type', '', 'success', 'Y', '0', 0, '2022-03-06 21:36:39', NULL, NULL, '子数据源');
INSERT INTO `sys_dict_data`
VALUES (40, 2, '主数据源', '1', 'sys_database_type', '', 'danger', 'N', '0', 0, '2022-03-06 21:36:39', NULL, NULL, '主数据源');
INSERT INTO `sys_dict_data`
...
INSERT INTO `sys_dict_data`
VALUES (45, 0, '全部数据权限', '1', 'sys_data_scope', '', '', 'Y', '0', 0, '2022-03-06 21:36:39', NULL, NULL, '全部数据权限');
INSERT INTO `sys_dict_data`
VALUES (46, 1, '自定数据权限', '2', 'sys_data_scope', '', '', 'N', '0', 0, '2022-03-06 21:36:39', NULL, NULL, '自定数据权限');
INSERT INTO `sys_dict_data`
VALUES (47, 2, '本部门数据权限', '3', 'sys_data_scope', '', '', 'N', '0', 0, '2022-03-06 21:36:39', NULL, NULL, '本部门数据权限');
INSERT INTO `sys_dict_data`
VALUES (48, 3, '本部门及以下数据权限', '4', 'sys_data_scope', '', '', 'N', '0', 0, '2022-03-06 21:36:39', NULL, NULL,
        '本部门及以下数据权限');
INSERT INTO `sys_dict_data`
VALUES (49, 4, '本岗位数据权限', '5', 'sys_data_scope', '', '', 'N', '0', 0, '2022-03-06 21:36:39', NULL, NULL, '本岗位数据权限');
INSERT INTO `sys_dict_data`
VALUES (50, 5, '仅本人数据权限', '6', 'sys_data_scope', '', '', 'N', '0', 0, '2022-03-06 21:36:39', NULL, NULL, '仅本人数据权限');
...
-- ----------------------------
INSERT INTO `sys_job`
VALUES (1, '系统默认（无参）', 'DEFAULT', 'ryTask.ryNoParams', '0/10 * * * * ?', '3', '1', '1', NULL, '2022-03-06 21:36:40',
        NULL, NULL, NULL, 0, 0);
INSERT INTO `sys_job`
...
VALUES (3, '系统默认（多参）', 'DEFAULT', 'ryTask.ryMultipleParams(\'ry\', true, 2000L, 316.50D, 100)', '0/20 * * * * ?', '3',
        '1', '1', NULL, '2022-03-06 21:36:40', NULL, NULL, NULL, 0, 0);
...
INSERT INTO `sys_menu`
VALUES (10210, 10200, '资料管理', 'dict', 'system/dataSetting/enterprise/profile/index', '', 'Y', 'N', 'N', 'N', 'C', 'Y',
        'system:enterprise:list', 'xy_dict', 1, '0', 0, '2022-03-06 21:36:38', NULL, NULL, '资料管理菜单', 0, 0, 0);
INSERT INTO `sys_menu`
VALUES (10211, 10210, '资料查看权限', '#', '', '', 'Y', 'N', 'N', 'N', 'F', 'N', 'system:enterprise:list', '#', 1, '0', 0,
        '2022-03-06 21:36:38', NULL, NULL, '', 0, 0, 0);
INSERT INTO `sys_menu`
VALUES (10212, 10210, '普通操作权限', '#', '', '', 'Y', 'N', 'N', 'N', 'F', 'N', 'system:enterprise:edit', '#', 2, '0', 0,
        '2022-03-06 21:36:38', NULL, NULL, '', 0, 0, 0);
INSERT INTO `sys_menu`
VALUES (10213, 10210, '超管操作权限', '#', '', '', 'Y', 'N', 'N', 'N', 'F', 'N', 'system:enterpriseAdmin:edit', '#', 3, '0',
...
VALUES (10321, 10320, '操作日志', 'operlog', 'system/system/journal/operlog/index', '', 'Y', 'N', 'N', 'N', 'C', 'Y',
        'system:operlog:list', 'xy_log_operation', 1, '0', 0, '2022-03-06 21:36:38', NULL, NULL, '操作日志菜单', 0, 0, 0);
INSERT INTO `sys_menu`
...
VALUES (10324, 10321, '日志导出', '#', '', '', 'Y', 'N', 'N', 'N', 'F', 'N', 'system:operlog:export', '#', 3, '0', 0,
        '2022-03-06 21:36:38', NULL, NULL, '', 0, 0, 0);
INSERT INTO `sys_menu`
VALUES (10325, 10320, '登录日志', 'loginInfo', 'system/system/journal/loginInfo/index', '', 'Y', 'N', 'N', 'N', 'C', 'Y',
        'system:loginInfo:list', 'xy_log_loginInfo', 2, '0', 0, '2022-03-06 21:36:38', NULL, NULL, '登录日志菜单', 0, 0, 0);
INSERT INTO `sys_menu`
...
VALUES (10511, 10510, '在线查询', '#', '', '', 'Y', 'N', 'N', 'N', 'F', 'N', 'monitor:online:query', '#', 1, '0', 0,
        '2022-03-06 21:36:38', NULL, NULL, '', 0, 0, 0);
INSERT INTO `sys_menu`
VALUES (10512, 10510, '批量强退', '#', '', '', 'Y', 'N', 'N', 'N', 'F', 'N', 'monitor:online:batchLogout', '#', 2, '0', 0,
        '2022-03-06 21:36:38', NULL, NULL, '', 0, 0, 0);
INSERT INTO `sys_menu`
VALUES (10513, 10510, '单条强退', '#', '', '', 'Y', 'N', 'N', 'N', 'F', 'N', 'monitor:online:forceLogout', '#', 3, '0', 0,
        '2022-03-06 21:36:38', NULL, NULL, '', 0, 0, 0);
INSERT INTO `sys_menu`
VALUES (10520, 10500, '定时任务', 'job', 'system/monitor/job/index', '', 'Y', 'N', 'N', 'N', 'C', 'Y', 'monitor:job:list',
        'xy_job', 2, '0', 0, '2022-03-06 21:36:38', NULL, NULL, '定时任务菜单', 0, 0, 0);
INSERT INTO `sys_menu`
...
VALUES (10526, 10520, '任务导出', '#', '', '', 'Y', 'N', 'N', 'N', 'F', 'N', 'monitor:job:export', '#', 6, '0', 0,
        '2022-03-06 21:36:38', NULL, NULL, '', 0, 0, 0);
INSERT INTO `sys_menu`
VALUES (10600, 0, '素材管理', NULL, NULL, '', 'Y', 'N', 'N', 'N', 'M', 'N', '', 'xy_tool', 9, '0', 0, '2022-03-06 21:36:38',
        NULL, NULL, '素材管理目录', 0, 0, 0);
INSERT INTO `sys_menu`
...
INSERT INTO `sys_menu`
VALUES (20010, 20000, '租户管理', 'tenant', 'tenant/tenant/index', '', 'N', 'N', 'N', 'N', 'C', 'Y', 'tenant:tenant:list',
        'xy_tenant', 1, '0', 0, '2022-03-06 21:36:38', NULL, NULL, '租户管理菜单', 0, 2, -1);
INSERT INTO `sys_menu`
...
VALUES (20015, 20010, '租户删除', '#', '', '', 'N', 'N', 'N', 'N', 'F', 'N', 'tenant:tenant:remove', '#', 5, '0', 0,
        '2022-03-06 21:36:38', NULL, NULL, '', 0, 2, -1);
INSERT INTO `sys_menu`
VALUES (20020, 20000, '数据源管理', 'source', 'tenant/source/index', '', 'N', 'N', 'N', 'N', 'C', 'Y', 'tenant:source:list',
        'xy_source', 1, '0', 0, '2022-03-06 21:36:38', NULL, NULL, '数据源菜单', 0, 2, -1);
INSERT INTO `sys_menu`
...
VALUES (20050, 20000, '策略管理', 'strategy', 'tenant/strategy/index', '', 'N', 'N', 'N', 'N', 'C', 'Y',
        'tenant:strategy:list', 'xy_strategy', 1, '0', 0, '2022-03-06 21:36:38', NULL, NULL, '数据源策略菜单', 0, 2, -1);
INSERT INTO `sys_menu`
...
INSERT INTO `sys_menu`
VALUES (20110, 20100, '字典管理', 'dict', 'system/system/dict/index', '', 'N', 'N', 'N', 'N', 'C', 'Y', 'system:dict:list',
        'xy_dict', 1, '0', 0, '2022-03-06 21:36:38', NULL, NULL, '字典管理菜单', 0, 2, -1);
INSERT INTO `sys_menu`
...
(
    `system_id`   bigint(20)                                                     NOT NULL COMMENT '模块Id',
...
VALUES (2, '租户管理系统',
        ...
        'http://westChinaUI:81', 'N', 'Y', '1', 'Y', 'Y', 0, '0', NULL, '2022-03-06 13:19:52', NULL, NULL, '租户管理系统', 0,
        -1);
...
(
    ...
    `tenant_name_frequency` tinyint(4)                                                     NULL     DEFAULT 0 COMMENT '租户账号修改次数',
    ...
    UNIQUE INDEX `tenant_name_2` (`tenant_name`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
(
    ...
    `tenant_amount` int(10) UNSIGNED                                              NOT NULL DEFAULT 0 COMMENT '租户数量',
    `source_amount` int(10) UNSIGNED                                              NOT NULL DEFAULT 0 COMMENT '数据源数量',
